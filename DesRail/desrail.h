...
namespace DesRail {
	...
	private:
		struct AccessRequest {
			...
			AccessRequest(Train* _train, Terminal* _target, DirectedSegment* _from_arc);
		};
	...
	public:
		...
		struct ConstraintArc {
			...
			ConstraintArc(DirectedSegment* _arc, Terminal* _target) :
				arc(_arc), target(_target) {}
		...
		void add_constraint_arc(DirectedSegment* _arc, Terminal* _target);

		bool is_violated(DirectedSegment* _arc_req, Train* _train);
